...
import { useGetAllSurveysOfUserQuery ,useSendSurveyMutation} from "../service/post";
...
function UsersTable() {
  ...
  const responseInfo = useGetAllSurveysOfUserQuery(5);
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      sx={{ cursor: "pointer" }}
                    >
                      <TableCell align="center">{row.surveyId}</TableCell>
                     
                      <TableCell align="left">{row.email}</TableCell>
                      <TableCell align="left">{row.surveyDate.split("T")[0]}</TableCell>
